...
const RecommendationsMovie = () => {
    ...
    return (
        <section className="w-full py-20">
            ...
            {/* Title */}
            <div className="mb-5">
                <img className="w-2/3 lg:w-auto" src="/Images/Movies/recommendationsHeader.png" alt="" />
            </div>
            ...
            <div className="relative">
                ...
                >
                    {castData.map((cast) => (
                        <div
                            key={cast.id}
                            className=" max-w-[250px] bg-[#1a3248] rounded-lg p-2 gap-4 text-white flex-shrink-0"
                        >
                            {/* Image */}
                            <img
                                src={cast.image}
                                className="w-full rounded border-4 border-white/20 object-cover"
                                alt="Season"
                            />

                            {/* Content */}
                            <div className="flex flex-col">
                                <h3 className="font-semibold text-lg mb-2">Archer </h3>
