...
const OthersInfo = () => {
    ...
    return (
        <div className="col-span-3 text-white">
            <h2 className="text-7xl font-semibold">Amir Khan</h2>

            {/* Biography */}
            <div className="my-10">
                <h3 className="text-xl mb-2">Biography</h3>
                <p className="text-gray-400">
                   Rainn Dietrich Wilson (born January 20, 1966) is an American actor and comedian. He is primarily known for his role as Dwight Schrute on The Office.Rainn Dietrich Wilson (born January 20, 1966) is an American actor and comedian. He is primarily known for his role as Dwight Schrute on The Office.Rainn Dietrich Wilson (born January 20, 1966) is an American actor and comedian. He is primarily known for his role as Dwight Schrute on The Office.Rainn Dietrich Wilson (born January 20, 1966) is an American actor and comedian. He is primarily known for his role as Dwight Schrute on The Office.
                </p>
            </div>

            {/* Known For */}
            <div>
                <h3 className="text-xl font-semibold mb-5">Known For</h3>

                {/* MASK */}
                <div className="knownfor-wrapper">
                    <div className="knownfor-track">
                        {[...Array(8)].map((_, index) => (
                            <div className="knownfor-card" key={index}>
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-CjXy5nSmZygvEe2lQVzaJx6pH2XDtwByMX_BsXZFjwlmjlrpTQdeg-hBqyb9FbK7aLyE&s=10"
                                    alt=""
                                />
                                <p>3 Idiots</p>
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="flex text-white my-3 items-center justify-between flex-wrap gap-3">
                    <h3 className="text-xl font-semibold mb-5">Acting</h3>
                ...
                <h3 className="text-xl font-semibold my-5">Production</h3>
                <div className="space-y-3">
                    {
                ...
                <h3 className="text-xl font-semibold my-5">Directing</h3>
                <div className="space-y-3">
                    {
